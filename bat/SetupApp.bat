...
:: Android packaging
set AND_CERT_NAME="CustomPotoboth"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CustomPotoboth.p12
...
set IOS_PROVISION=cert\CustomPotoboth.mobileprovision
